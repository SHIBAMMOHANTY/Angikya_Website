...
const HeroSection = () => {
  return (
    <div className="flex flex-col lg:flex-row items-center justify-between  relative  xl:min-h-[90vh] px-3 md:px-6 lg:px-12 xl:px-20 py-10">
      {/* Cursor Effect */}
      ...
      <div className="lg:w-1/2 text-center lg:text-left ">
        <h1 className="text-4xl sm:text-6xl lg:text-7xl font-bold tracking-wide">
          ANGIKYA{" "}
          <span className="bg-gradient-to-r from-blue-600 via-blue-500 to-blue-400 text-transparent bg-clip-text"></span>
        </h1>
      ...
      <div className="relative lg:w-1/2 flex justify-center items-center mt-10 lg:mt-0">
        ...
        <div className="absolute -bottom-8 -right-2 lg:-right-8 w-36 sm:w-44 md:w-56 lg:w-64 border border-blue-400 rounded-xl overflow-hidden shadow-lg backdrop-blur-lg bg-white/10 hover:scale-110 hover:shadow-blue-400/50 transition-transform duration-500">
          <video
            autoPlay
            loop
            muted
